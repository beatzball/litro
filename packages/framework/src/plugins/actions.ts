 ...
 *   4. The endpoint route itself is declared statically in the consumer's
 *      nitro.config.ts handlers array pointing at that generated stub
 *      (a build:before push into nitro.options.handlers never reaches the
 *      dev server — see the NOTE at the bottom of this file)
 *
...
// @generated by litro action scanner — do not edit
// Runtime handler for POST /__litro/action/:id — generated by the litro
// actions plugin; the route is declared in nitro.config.ts handlers.
