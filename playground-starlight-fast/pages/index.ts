...
// Register components used in template — namespace imports prevent Rollup from
// tree-shaking these side-effect-only imports (element registration).
...
export const routeMeta = {
  head: starlightHead,
  title: 'playground-starlight-fast',
};
...
const template = html<SplashPage>`
  ${(x) => {
    ...
    const siteTitle = data?.siteTitle ?? 'playground-starlight-fast';
