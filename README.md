...
| Metric          | Litro (v0.8.1) | Next.js (v14.2.35) | Nuxt (v3.21.2) |
|-----------------|--- | --- | ---|
| Build time      | **894ms** | 4.8s | 1.9s |
| Output size     | **35.3 KB** | 702.8 KB | 200.1 KB |
| Avg page weight | 2.0 KB gzip | 1.5 KB gzip | **665.5 B gzip** |

> Auto-generated by `scripts/update-readme-bench.mjs` from `benchmarks/results/latest.json`.
> Measured on Apple M4 Max, Node v24.7.0 (2026-04-20). Run `pnpm bench:cross` to reproduce.
