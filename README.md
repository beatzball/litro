...
- **Recipe-based scaffolding** — `fullstack`, `11ty-blog`, `starlight`, and `supernova` recipes via `npm create @beatzball/litro`
...
| Metric          | Litro (v0.16.2) | Next.js (v16.3.6) | Nuxt (v4.5.2) |
|-----------------|--- | --- | ---|
| Build time      | **954ms** | 2.9s | 1.8s |
| Output size     | **37.0 KB** | 620.1 KB | 201.6 KB |
| Avg page weight | 1.7 KB gzip | 1.7 KB gzip | **714.5 B gzip** |

> Auto-generated by `scripts/update-readme-bench.mjs` from `benchmarks/results/latest.json`.
> Measured on Apple M4 Max, Node v24.7.0 (2026-09-24). Run `pnpm bench:cross` to reproduce.
