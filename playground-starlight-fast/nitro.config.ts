...
export default defineNitroConfig({
  ...
  // Force local component .ts files to be bundled (not externalized) so
  // Nitro's esbuild compiles @observable decorators with experimentalDecorators.
  // Without this, the prerenderer loads .ts files at runtime via jiti which
  // uses a different (incompatible) decorator transform.
  externals: {
