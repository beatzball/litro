...
|-----------------|--- | --- | ---|
| Build time      | **1.3s** | 3.1s | 3.7s |
| Output size     | **37.5 KB** | 620.1 KB | 201.6 KB |
| Avg page weight | 1.7 KB gzip | 1.7 KB gzip | **713.5 B gzip** |

> Auto-generated by `scripts/update-readme-bench.mjs` from `benchmarks/results/latest.json`.
> Measured on Apple M4 Max, Node v24.7.0 (2026-09-23). Run `pnpm bench:cross` to reproduce.
