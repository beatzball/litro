import { html, css, when } from '@microsoft/fast-element';
...
export const routeMeta = {
  head: starlightHead,
  title: 'Docs — playground-starlight-fast',
};

export class DocPage extends LitroPage {}

const template = html<DocPage>`
  ${(x) => {
...
DocPage.define({ name: 'page-docs-slug', template, styles });
