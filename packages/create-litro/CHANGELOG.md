...
- 1f347da: Fix two defects in every recipe's catch-all page handler.
...
- a631454: supernova: add a "one thing, proved" band to the landing page
...
- 8b5172c: Stop every scaffolded site scrolling sideways on a phone.
