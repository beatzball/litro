...
export default async function viteDevPlugin(nitro: Nitro): Promise<void> {
  ...
  // Hook into nitro:init — this fires after Nitro has fully configured itself
  // but before the dev server starts listening. This is the correct point to
  // push entries into nitro.options.devHandlers.
